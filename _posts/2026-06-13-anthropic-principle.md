...
No, this isn't related to Anthropic, [the startup](https://www.anthropic.com/). 
...
The second hypothesis is the usual: the universe started with the big bang, it will expand, and then "die" (insert your favorite death of the universe here). We will call this "Permanent death" hypothesis or PD. 

## Big Bang

Let's suppose that the probability that a single cycle generates intelligent life under EH is some extraordinarily small number $$p$$, and likewise for PD. Now we can return to our original question: which hypothesis should we believe? Do we live in EH or do we live in PD?

At first glance, it seems that EH should be far more likely. Why? If intelligent observers are incredibly unlikely to arise in any given cycle, then the fact that I find myself existing might be evidence that the universe had many opportunities to produce observers. In other words, perhaps my existence is evidence in favor of EH over PD.[^2]

However, there is another way to think about it. Although intelligent life may be exceedingly *improbable*, it isn't **impossible* under PD. Perhaps I simply happened to live in the one universe where the unlikely occurred. If so, then the mere fact that I exist should not, by itself, make EH any more likely than PD.
